    ...
    <div className="fixed top-0 left-0 right-0 z-50">
      <div className="px-2 pt-2">
        <div className="flex items-center gap-2">
          {/* Name and Flags */}
          <div className="backdrop-blur-sm bg-white/60 rounded-lg px-3 py-2 min-w-[200px]">
            <div>
              <div className="text-2xl font-bold gradient-text font-dancing">
                Suvadeep Mukherjee
              </div>
          ...
          <div className="flex-1">
            <div className="backdrop-blur-md bg-white/30 rounded-2xl border border-gray-700/50 shadow-lg p-1">
              <div className="flex items-center justify-between h-8 px-2 gap-2">
                <div className="flex items-center space-x-1 transition-transform duration-300">
                  <button
                    ...
                    aria-label="Home"
                  >
                    <FaApple className="text-cyan-400 text-xl" />
                  </button>
                  ...
                  <div className="flex items-center space-x-1">
                    <span className="text-gray-500 text-xl">~</span>
                    <span className="text-gray-500 text-xl">/</span>
                    <span className="text-gray-700 min-w-[60px] text-xl">
                      <TypeAnimation
                        key={pathKey}
              ...
              <nav className="flex flex-col">
                {sections.map((section) => (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 text-left transition-colors duration-200 text-lg 
                      ${
